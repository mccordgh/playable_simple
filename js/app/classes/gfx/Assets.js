define(['Class', 'ImageLoader', 'SpriteSheet', 'Animation'], function(Class,ImageLoader,SpriteSheet, Animation){
	...
	var luka = new Assets("luka", CURRENT_PATH + "res/textures/cta_luka.png", 65, 81);
	luka.model = luka.sheet.crop(0, 0, 65, 81);

	var boss = new Assets("boss", CURRENT_PATH + "res/textures/cta_boss.png", 300, 391);
	boss.model = boss.sheet.crop(0, 0, 300, 391);

	var scene = new Assets("scene", CURRENT_PATH + "res/textures/cta_scene_scale.png", 980, 1743);
	scene.model = scene.sheet.crop(0, 0, 980, 1743);

	var spawn = new Assets("spawn", CURRENT_PATH + "res/textures/cta_spawn.png", 92, 102);
	spawn.model = spawn.sheet.crop(0, 0, 92, 102);
